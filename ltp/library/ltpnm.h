...
void	ltpnm_spanEngineIds_get(unsigned int engineIds[], int *numIds);
void	ltpnm_span_get(unsigned int engineId, NmltpSpan *stats,
			int *success);
void	ltpnm_span_reset(unsigned int engineId, int *success);
