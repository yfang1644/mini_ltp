...
int	ionadmin(int, int, int, int, int, int, int, int, int, int);
int	ionexit(int, int, int, int, int, int, int, int, int, int);
int	ltpadmin(int, int, int, int, int, int, int, int, int, int);
int	bpadmin(int, int, int, int, int, int, int, int, int, int);
int	ipnadmin(int, int, int, int, int, int, int, int, int, int);
int	rfxclock(int, int, int, int, int, int, int, int, int, int);
int	ltpclock(int, int, int, int, int, int, int, int, int, int);
int	ltpmeter(int, int, int, int, int, int, int, int, int, int);
int	bpclock(int, int, int, int, int, int, int, int, int, int);
int	bptransit(int, int, int, int, int, int, int, int, int, int);
int	bpclm(int, int, int, int, int, int, int, int, int, int);
int	ipnfw(int, int, int, int, int, int, int, int, int, int);
int	ltpcli(int, int, int, int, int, int, int, int, int, int);
int	ltpclo(int, int, int, int, int, int, int, int, int, int);
int	udplsi(int, int, int, int, int, int, int, int, int, int);
int	udplso(int, int, int, int, int, int, int, int, int, int);
int	aoslsi(int, int, int, int, int, int, int, int, int, int);
int	aoslso(int, int, int, int, int, int, int, int, int, int);
int	udpcli(int, int, int, int, int, int, int, int, int, int);
int	udpclo(int, int, int, int, int, int, int, int, int, int);
int	tcpcli(int, int, int, int, int, int, int, int, int, int);
int	tcpclo(int, int, int, int, int, int, int, int, int, int);
int	brsccla(int, int, int, int, int, int, int, int, int, int);
int	brsscla(int, int, int, int, int, int, int, int, int, int);
int	ipnadminep(int, int, int, int, int, int, int, int, int, int);
